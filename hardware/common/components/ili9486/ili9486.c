...
static esp_err_t panel_ili9486_disp_off(esp_lcd_panel_t *panel, bool off);
...
esp_err_t esp_lcd_new_panel_ili9486(const esp_lcd_panel_io_handle_t io, const esp_lcd_panel_dev_config_t *panel_dev_config, esp_lcd_panel_handle_t *ret_panel) {
    ...
    ili9486 = calloc(1, sizeof(ili9486_panel_t));
    ESP_GOTO_ON_FALSE(ili9486, ESP_ERR_NO_MEM, err, "", "no mem for ili9486 panel");
    ...
    case 16:
        ili9486->colmod_cal = 0x55;
        break;
    case 18:
        ili9486->colmod_cal = 0x66;
        break;
    default:
    ...
    ili9486->io = io;
    ili9486->bits_per_pixel = panel_dev_config->bits_per_pixel;
    ...
    ili9486->base.disp_on_off = panel_ili9486_disp_off;
    *ret_panel = &(ili9486->base);
    esp3d_log("new ili9486 panel @%p", ili9486);
...
static esp_err_t panel_ili9486_del(esp_lcd_panel_t *panel) {
    ...
    esp3d_log("del ili9486 panel @%p", ili9486);
    free(ili9486);
    return ESP_OK;
}
...
static esp_err_t panel_ili9486_draw_bitmap(esp_lcd_panel_t *panel, int x_start, int y_start, int x_end, int y_end, const void *color_data) {
    ...
    size_t len = (x_end - x_start) * (y_end - y_start) * ili9486->bits_per_pixel / 8;
